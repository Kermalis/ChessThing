...
{
	[Theory]
	[InlineData("a3   ", 2, Col.MAX, Col.CA, Row.R3, false, false, false)]
	[InlineData("h6   ", 2, Col.MAX, Col.CH, Row.R6, false, false, false)]
	[InlineData("d4   ", 2, Col.MAX, Col.CD, Row.R4, false, false, false)]
	[InlineData("a3+  ", 3, Col.MAX, Col.CA, Row.R3, false, true, false)]
	[InlineData("a3#  ", 3, Col.MAX, Col.CA, Row.R3, false, true, true)]
	...
	public void SimplePawnMove(string str, int numChars, Col fromCol, Col toCol, Row toRow, bool capture, bool check, bool checkmate)
	{
		...
		Assert.Equal(Row.MAX, m.FromRowHint);
		Assert.Equal(toCol, m.ToHint.Col);
		Assert.Equal(toRow, m.ToHint.Row);
	...
	[Theory]
	[InlineData("a8=Q   ", 4, Col.MAX, Col.CA, Row.R8, PieceKind.Queen, false, false, false)]
	[InlineData("c1=B   ", 4, Col.MAX, Col.CC, Row.R1, PieceKind.Bishop, false, false, false)]
	[InlineData("h8=R+  ", 5, Col.MAX, Col.CH, Row.R8, PieceKind.Rook, false, true, false)]
	[InlineData("b1=N#  ", 5, Col.MAX, Col.CB, Row.R1, PieceKind.Knight, false, true, true)]
	...
	[Theory]
	[InlineData("Nf3    ", 3, Col.MAX, Row.MAX, Col.CF, Row.R3, PieceKind.Knight, false, false, false)]
	[InlineData("Rg4    ", 3, Col.MAX, Row.MAX, Col.CG, Row.R4, PieceKind.Rook, false, false, false)]
	[InlineData("Bc8+   ", 4, Col.MAX, Row.MAX, Col.CC, Row.R8, PieceKind.Bishop, false, true, false)]
	[InlineData("Qa7#   ", 4, Col.MAX, Row.MAX, Col.CA, Row.R7, PieceKind.Queen, false, true, true)]
	[InlineData("Kd1    ", 3, Col.MAX, Row.MAX, Col.CD, Row.R1, PieceKind.King, false, false, false)]
	[InlineData("Bxc8+  ", 5, Col.MAX, Row.MAX, Col.CC, Row.R8, PieceKind.Bishop, true, true, false)]
	[InlineData("Qxa7#  ", 5, Col.MAX, Row.MAX, Col.CA, Row.R7, PieceKind.Queen, true, true, true)]
	[InlineData("Kxd1   ", 4, Col.MAX, Row.MAX, Col.CD, Row.R1, PieceKind.King, true, false, false)]
	// These are semi-rare since they appear when multiple of the same piece spy the same square.
	// Typically Knights and Rooks.
	[InlineData("Nfd2   ", 4, Col.CF, Row.MAX, Col.CD, Row.R2, PieceKind.Knight, false, false, false)]
	[InlineData("Nfd2+  ", 5, Col.CF, Row.MAX, Col.CD, Row.R2, PieceKind.Knight, false, true, false)]
	[InlineData("Nfd2#  ", 5, Col.CF, Row.MAX, Col.CD, Row.R2, PieceKind.Knight, false, true, true)]
	[InlineData("Nfxd2  ", 5, Col.CF, Row.MAX, Col.CD, Row.R2, PieceKind.Knight, true, false, false)]
	[InlineData("Nfxd2+ ", 6, Col.CF, Row.MAX, Col.CD, Row.R2, PieceKind.Knight, true, true, false)]
	[InlineData("Nfxd2# ", 6, Col.CF, Row.MAX, Col.CD, Row.R2, PieceKind.Knight, true, true, true)]
	[InlineData("N3d2   ", 4, Col.MAX, Row.R3, Col.CD, Row.R2, PieceKind.Knight, false, false, false)]
	[InlineData("N3d2+  ", 5, Col.MAX, Row.R3, Col.CD, Row.R2, PieceKind.Knight, false, true, false)]
	[InlineData("N3d2#  ", 5, Col.MAX, Row.R3, Col.CD, Row.R2, PieceKind.Knight, false, true, true)]
	[InlineData("N3xd2  ", 5, Col.MAX, Row.R3, Col.CD, Row.R2, PieceKind.Knight, true, false, false)]
	[InlineData("N3xd2+ ", 6, Col.MAX, Row.R3, Col.CD, Row.R2, PieceKind.Knight, true, true, false)]
	[InlineData("N3xd2# ", 6, Col.MAX, Row.R3, Col.CD, Row.R2, PieceKind.Knight, true, true, true)]
	...
	public void CastleMove(string str, int numChars, bool kingside, bool check, bool checkmate)
	{
		...
		Assert.Equal(Col.MAX, m.FromColHint);
		Assert.Equal(Row.MAX, m.FromRowHint);
		Assert.True(m.ToHint.IsInvalid);
		Assert.Equal(PieceKind.None, m.PromotedPiece);
